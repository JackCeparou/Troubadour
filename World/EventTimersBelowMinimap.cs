...
public class EventTimersBelowMinimap : BasePlugin, IGameUserInterfacePainter
{
    ...
    public void PaintGameUserInterface(GameUserInterfaceLayer layer)
    {
        ...
        {
            var icon = marker.SubzoneSno.SnoId is SubzoneSnoId.Frac_WorldBoss or SubzoneSnoId.Hawe_WorldBoss or SubzoneSnoId.Kehj_WorldBoss or SubzoneSnoId.Scos_WorldBoss or SubzoneSnoId.Step_WorldBoss
